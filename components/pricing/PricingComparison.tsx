  ...
  const features = [
    {
      ...
      free: t('pricing.comparison.values.videoLength.free'),
      pro: t('pricing.comparison.values.videoLength.pro'),
      enterprise: t('pricing.comparison.values.videoLength.enterprise'),
    },
    {
      id: 'monthlyCredits',
      name: t('pricing.comparison.features.monthlyCredits'),
      free: t('pricing.comparison.values.monthlyCredits.free'),
      pro: t('pricing.comparison.values.monthlyCredits.pro'),
      enterprise: t('pricing.comparison.values.monthlyCredits.enterprise'),
    },
    {
      id: 'resolution',
      name: t('pricing.comparison.features.resolution'),
      free: t('pricing.comparison.values.resolution.free'),
      pro: t('pricing.comparison.values.resolution.pro'),
      enterprise: t('pricing.comparison.values.resolution.enterprise'),
    },
    {
      id: 'audioTracks',
      name: t('pricing.comparison.features.audioTracks'),
      free: t('pricing.comparison.values.audioTracks.free'),
      pro: t('pricing.comparison.values.audioTracks.pro'),
      enterprise: t('pricing.comparison.values.audioTracks.enterprise'),
    },
    {
      id: 'customModels',
